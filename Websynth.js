...
var synthTypes=[
	{ "X": 250, "Y": 40, "Width": 50, "Height" : 50, "type":"square", "selected" : true, "XOffset" : 5},
	{ "X": 350, "Y": 40, "Width": 50, "Height" : 50, "type":"sawtooth", "selected" : false},
	{ "X": 450, "Y": 40, "Width": 50, "Height" : 50, "type":"triangle", "selected" : false},
	{ "X": 550, "Y": 40, "Width": 50, "Height" : 50, "type":"sine", "selected" : false, "XOffset" : 12}
]
...
function drawKeys(){
	...
	for(button in synthTypes){
		...
		ctx.fillStyle = "Black"
		if(theKey["XOffset"] != undefined){
			ctx.fillText(theKey["type"],theKey["X"]+theKey["XOffset"],theKey["Y"]+theKey["Height"]/2,theKey["Width"],theKey["Height"])
		}else{
